...
const coverPath = "./cover.mp4"; // The visible video
const originalPath = "./original.jpg"; // The image to hide
const outputPath = "./result/steganographed.mp4"; // Output file
...
console.log("Video steganographed successfully:", outputPath);

const steganographedPath = "./result/steganographed.mp4";
